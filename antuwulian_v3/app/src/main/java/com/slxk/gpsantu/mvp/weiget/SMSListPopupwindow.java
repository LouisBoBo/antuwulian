...
import com.slxk.gpsantu.mvp.ui.adapter.PenetrateHistoryMenuAdapter;
...
public class SMSListPopupwindow extends PopupWindow {
    ...
    private void initData(){
        ...
        menuBeans.add(new SMSListMenuBean(0, mContext.getString(R.string.txt_order_rt),orderList[0]));
        menuBeans.add(new SMSListMenuBean(1, mContext.getString(R.string.txt_order_ft),orderList[1]));
        menuBeans.add(new SMSListMenuBean(2, mContext.getString(R.string.txt_order_cx),orderList[2]));
        menuBeans.add(new SMSListMenuBean(3, mContext.getString(R.string.txt_order_vr),orderList[3]));
