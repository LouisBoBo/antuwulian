...
public class TreeUserCheckAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    //上下文
    ...
    public TreeUserCheckAdapter(Context ctx, List<TreeData> allList, FamilyAdapterListener familyAdapterListener) {
        this.contextx = ctx;
...
//        }
    ...
    public BaseViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new BaseViewHolder(LayoutInflater.from(contextx).inflate(R.layout.item_tree_user_check, viewGroup, false));
    }
