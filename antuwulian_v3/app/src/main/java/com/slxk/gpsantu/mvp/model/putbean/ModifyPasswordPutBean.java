...
public class ModifyPasswordPutBean {
    ...
    public static class ParamsBean {
        ...
        private String auto_md5;  //秒验参数
        private String auto_operator; //秒验参数
        private String auto_optoken; //秒验参数
        private String auto_phone_operator; //秒验参数
        private String auto_token; //秒验参数

        public String getAuto_md5() {
            return auto_md5;
        }

        public void setAuto_md5(String auto_md5) {
            this.auto_md5 = auto_md5;
        }
        ...
        public void setAuto_operator(String auto_operator) {
            this.auto_operator = auto_operator;
        }
        ...
        public void setAuto_optoken(String auto_optoken) {
            this.auto_optoken = auto_optoken;
        }

        public String getAuto_phone_operator() {
            return auto_phone_operator;
        }

        public void setAuto_phone_operator(String auto_phone_operator) {
            this.auto_phone_operator = auto_phone_operator;
        }
