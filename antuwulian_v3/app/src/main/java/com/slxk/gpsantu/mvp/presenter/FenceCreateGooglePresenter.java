 ...
 */
@ActivityScope
public class FenceCreateGooglePresenter extends BasePresenter<FenceCreateGoogleContract.Model, FenceCreateGoogleContract.View> {
    @Inject
    ...
    @Inject
    public FenceCreateGooglePresenter (FenceCreateGoogleContract.Model model, FenceCreateGoogleContract.View rootView) {
