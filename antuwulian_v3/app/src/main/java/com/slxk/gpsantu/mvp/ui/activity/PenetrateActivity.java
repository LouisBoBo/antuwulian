...
public class PenetrateActivity extends BaseActivity<PenetratePresenter> implements PenetrateContract.View, View.OnClickListener {
    ...
    private List<String> mSimeis; // 如果查询特定账号的日志，可以对特定的设备号进行查询
    private List<Integer> mTypes; // 筛选指令类型，不填返回全部
    ...
    public void initData(@Nullable Bundle savedInstanceState) {
        ...
        if (mProtocol == 1 || mProtocol == 2 || mProtocol == 3) { //808-2011协议、808-2013协议、808-2019协议
