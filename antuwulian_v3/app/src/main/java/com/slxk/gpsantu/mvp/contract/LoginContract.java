...
public interface LoginContract {
    ...
    interface View extends IView {
        ...
        void submitBindMobileSuccess(RegisterResultBean baseBean, boolean isChangeBind);
    }
    ...
    interface Model extends IModel {
         ...
         * @return
         */
        Observable<RegisterResultBean> submitBindMobile(ModifyPasswordPutBean bean, String sid);
