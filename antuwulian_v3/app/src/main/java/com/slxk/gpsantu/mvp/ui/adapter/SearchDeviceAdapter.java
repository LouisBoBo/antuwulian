 ...
 * 搜索设备
 */
public class SearchDeviceAdapter extends BaseQuickAdapter<FindDeviceResultBean.ItemsBean, BaseViewHolder> {

    public SearchDeviceAdapter(int layoutResId, @Nullable List<FindDeviceResultBean.ItemsBean> data) {
