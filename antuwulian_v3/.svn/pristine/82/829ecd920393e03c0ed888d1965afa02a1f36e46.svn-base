...
public class HintView extends RelativeLayout {
    ...
    private int tvOffsetX = 0, tvOffsetY = 0;
    private int radius;
    ...
    public void setTvOffsetX(int offsetX) { this.tvOffsetX = offsetX; }

    public void setTvOffsetY(int offsetY) { this.tvOffsetY = offsetY; }
    ...
    private void addFuzzyLayerView() {
        ...
        if (center == null) {
            ...
            center[1] = location[1] + targetView.getHeight() / 2 + this.tvOffsetY;
        }
    ...
    public static class Builder {
         ...
         * 设置目标view的偏移量
         */
        public Builder setTargetVieOffset(int x, int y) {
            hintView.setTvOffsetX(x);
            hintView.setTvOffsetY(y);
            return instance;
        }
