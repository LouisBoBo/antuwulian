 ...
 */
@ActivityScope
public class AlarmSetSpecialModel extends BaseModel implements AlarmSetSpecialContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public AlarmSetSpecialModel(IRepositoryManager repositoryManager) {
