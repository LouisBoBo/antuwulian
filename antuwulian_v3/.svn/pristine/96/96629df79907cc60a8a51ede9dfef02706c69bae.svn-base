...
//    }
    ...
    private String priority; // 定位优先级
    private String last_pos; //位置信息json格式
    private List<Integer> increment; //增值服务,返回配置代码type; 默认不返回，开启了get_increment之后才返回
    ...
    public static class DetailBean {
        ...
        private int mode_id = 1;  // 模式id
        private String mode_name; // 模式名称
