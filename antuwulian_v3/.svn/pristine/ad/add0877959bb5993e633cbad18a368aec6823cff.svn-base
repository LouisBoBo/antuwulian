 ...
 */
@ActivityScope
public class BindForeignActivityPresenter extends BasePresenter<BindForeignActivityContract.Model, BindForeignActivityContract.View> {
    @Inject
    ...
    @Inject
    public BindForeignActivityPresenter(BindForeignActivityContract.Model model, BindForeignActivityContract.View rootView) {
