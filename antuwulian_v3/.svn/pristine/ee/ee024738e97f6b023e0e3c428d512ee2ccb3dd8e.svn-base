 ...
 */
@ActivityScope
public class BindForeignActivityModel extends BaseModel implements BindForeignActivityContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public BindForeignActivityModel(IRepositoryManager repositoryManager) {
