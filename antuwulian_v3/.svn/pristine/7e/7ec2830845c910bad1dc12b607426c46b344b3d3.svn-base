 ...
 */
@ActivityScope
public class RealTimeTrackGooglePresenter extends BasePresenter<RealTimeTrackGoogleContract.Model, RealTimeTrackGoogleContract.View> {
    @Inject
    ...
    @Inject
    public RealTimeTrackGooglePresenter (RealTimeTrackGoogleContract.Model model, RealTimeTrackGoogleContract.View rootView) {
