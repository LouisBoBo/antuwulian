 ...
 */
@ActivityScope
public class AlarmClockPresenter extends BasePresenter<AlarmClockContract.Model, AlarmClockContract.View> {
    @Inject
    ...
    @Inject
    public AlarmClockPresenter (AlarmClockContract.Model model, AlarmClockContract.View rootView) {
