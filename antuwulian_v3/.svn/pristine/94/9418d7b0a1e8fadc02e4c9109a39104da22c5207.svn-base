...
public class BitmapHelperBaidu {
    ...
    public BitmapHelperBaidu(Context context) {
        ...
        Bitmap startBitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.qi);
        Bitmap endBitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.end);
        Bitmap parkingBitmap = BitmapFactory.decodeResource(context.getResources(),R.drawable.ic_path_parking);
